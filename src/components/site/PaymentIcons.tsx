/**
 * Payment method icons — SVGs extraídos diretamente do footer do blanq.uk
 * Seção: footer__payment flex grow-1 justify-center flex-md-end align-center max-w-100
 *
 * Ícones presentes (ordem original do site):
...
const methods = [
  { id: "amex",       label: "American Express", Icon: AmericanExpress },
  { id: "applepay",   label: "Apple Pay",        Icon: ApplePay },
  { id: "diners",     label: "Diners Club",      Icon: DinersClub },
  { id: "discover",   label: "Discover",         Icon: Discover },
  { id: "googlepay",  label: "Google Pay",       Icon: GooglePay },
...
export function PaymentIcons({ className = "" }: { className?: string }) {
  return (
    <ul
      className={`list-none flex flex-wrap gap-5 justify-center flex-md-end ${className}`}
      aria-label="Accepted payment methods"
    >
      {methods.map(({ id, label, Icon }) => (
        <li key={id} className="lh-normal inline-flex align-center" title={label}>
          <Icon />
        </li>
      ))}
    </ul>
